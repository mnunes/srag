pageWithSidebar(
  ...
  sidebarPanel(
    ...
    p("Aplicativo desenvolvido por", a("Marcus Nunes", href="https://marcusnunes.me/", target="_blank"), ". O código está disponível", a("no github", href="https://github.com/mnunes/subnotificacao/", target="_blank"), ".")
  ),
